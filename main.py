...
def mainmenu():
    ...
    imgSelectIcon = ImageTk.PhotoImage(Image.open(PATH + "/materials/image_icon.png").resize((40,40)))
    ...
    settingsIcon = ImageTk.PhotoImage(Image.open(PATH + "/materials/settings_icon.png").resize((30,30)))
